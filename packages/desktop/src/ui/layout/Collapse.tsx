...
export function Collapse({ open, children, bodyClassName, keepMounted = false }: {
	open: boolean;
	children: ReactNode;
	...
	return <div className="ly-reveal ly-freeze" data-open={open} inert={!open} aria-hidden={!open}
